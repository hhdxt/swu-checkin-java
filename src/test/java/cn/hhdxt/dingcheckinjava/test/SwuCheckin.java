package cn.hhdxt.dingcheckinjava.test;
...
public class SwuCheckin {
    ...
    public static void main(String[] args) {
        ...
        if (username == null || password == null) {
            System.out.println("缺少用户名或密码。请通过环境变量或命令行参数提供。");
            System.exit(2);
        }
        ...
        try {
            ...
            System.err.println("运行过程中发生错误: " + e.getMessage());
            e.printStackTrace();
            System.exit(1);
        }
    }
    ...
    private static boolean login(String username, String password) throws Exception {
        ...
        String body = String.format("IDToken1=%s&IDToken2=%s&IDToken3=&goto=%s&gotoOnFail=&sunQueryParamsString=%s&encoded=true&gx_charset=UTF-8",
                ...
                URLEncoder.encode("cmVhbG09LyZzZXJ2aWNlPWluaXRTZXJ2aWNlJg==", StandardCharsets.UTF_8)
        );
